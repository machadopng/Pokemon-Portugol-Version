programa
{
	...
	inteiro escolha_
	cadeia poder_p[4] = {poder_pokemon[Baka]}
     ...
     funcao regepokemon() //Aqui é definido os atributos de cada pokemon.
	{
			       ...
			       cadeia poder_pokemon[7] = {"Tackle", "Growl", "Leech Seed", "Vine Whip", "Tail Whip", "Bubble", "Water Gun"}
			       se(seupkmn == 1){
			       	
				     escreva(poder_pokemon[0])
				     para(inteiro Baka=1; Baka <= 3; Baka++){
					escreva(poder_pokemon[Baka])

					poder_p[4] = poder_pokemon[Baka]
